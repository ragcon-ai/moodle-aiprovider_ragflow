...
$string['cachedef_chatrate'] = 'Zeitstempel für die Chat-Ratenbegrenzung';
$string['cachedef_datasets'] = 'RAGflow-Datensatzlisten (Konfig-Autovervollständigung)';
$string['cachedef_docurls'] = 'Dokument-Quelllinks je Datensatz';
$string['cachedef_kbbound'] = 'Marker für Wissensdatenbank-Bindung';
$string['cachedef_refstatus'] = 'Referenzstatus-Ergebnisse (Assistent/KB/Speicher)';
