...
$string['cachedef_chatrate'] = 'Chat rate-limit request timestamps';
$string['cachedef_datasets'] = 'RAGflow dataset lists (config autocomplete)';
$string['cachedef_docurls'] = 'Document source links per dataset';
$string['cachedef_kbbound'] = 'Knowledge-base binding markers';
$string['cachedef_refstatus'] = 'Reference status verdicts (assistant/KB/memory)';
