...
/**
 * Reset the current user's conversation memory for the given context (starts a fresh RAGflow session).
 *
 * @package    aiprovider_ragflow
 * @copyright  2026 RAGcon GmbH <info@ragcon.ai>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class chat_reset extends external_api {
    /**
     * Parameters.
     *
    ...
    /**
     * Reset the session (new conversation). Long-term memory persists across this by design.
     *
     * @param int $contextid
    ...
    public static function execute(int $contextid, string $component): array {
        ...
        \aiprovider_ragflow\chat_engine::reset($component, (int) $USER->id);
        return ['success' => true];
    }
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'success' => new external_value(PARAM_BOOL, 'Whether the conversation was reset.'),
        ]);
    }
}
